...
def make_dataset(root_path, annotation_path, subset, n_samples_for_each_video,
    ...
    for i in range(len(video_names)):
        ...
        # if n_samples_for_each_video > 1, it either choose n_samples or a frame as a sample
        # if specify < 1 then selects all subsamples each with sample_duration length
        else:
            if n_samples_for_each_video > 1:
                step = max(1,
